  ...
  return (
    <>
      <article
        ...
        className="group relative overflow-hidden rounded-lg border-2 border-border bg-card transition-all duration-500 hover:border-accent hover:-translate-y-2 hover:shadow-[0_0_30px_hsl(var(--accent)/0.35),0_20px_40px_-15px_hsl(var(--accent)/0.2)] cursor-pointer"
      >
        <div className="h-1.5 bg-gradient-to-r from-transparent via-accent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
